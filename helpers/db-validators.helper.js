...
const validateAllowedCollection = (collectName = '', collectionsAllowed = []) => {
  if (!collectionsAllowed.includes(collectName)) throw new Error(`CollectName: ${collectName} NOT allowed || collectionsAllowed: ${collectionsAllowed}`);
  return true;
};
